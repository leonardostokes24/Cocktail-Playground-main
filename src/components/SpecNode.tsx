...
export default function SpecNode({ id, data, selected }: any) {
  ...
  return (
    ...
    >
      ...
      <Handle id="target-left" type="target" position={Position.Left} style={{ background: '#fff', width: '4px', height: '12px', borderRadius: '1px', border: `1px solid ${borderColor}` }} />
      ...
      <Handle id="source-right" type="source" position={Position.Right} style={{ background: '#fff', width: '4px', height: '12px', borderRadius: '1px', border: `1px solid ${borderColor}` }} />
    </div>
  );
}
